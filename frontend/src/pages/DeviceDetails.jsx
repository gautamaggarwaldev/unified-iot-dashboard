        ...
        <div className="flex-1 flex flex-col min-w-0">
          ...
          <div className="flex-1 flex items-center justify-center p-4">
            <div className="text-center">
              ...
              <p className="text-sm sm:text-base text-slate-600">Loading device...</p>
            </div>
          </div>
        </div>
      </div>
          ...
          <div className="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-4 gap-4 sm:gap-5 lg:gap-6 mb-6 sm:mb-8">
            <div className="bg-white rounded-lg border border-slate-200 p-4 sm:p-5 lg:p-6">
              <div className="flex items-center gap-3 mb-3">
                ...
                <p className="text-xs sm:text-sm font-medium text-slate-500">Device ID</p>
              </div>
              <h3 className="text-base sm:text-lg lg:text-xl font-bold text-slate-900 truncate">{device.deviceId}</h3>
            </div>
            ...
            <div className="bg-white rounded-lg border border-slate-200 p-4 sm:p-5 lg:p-6">
              <div className="flex items-center gap-3 mb-3">
                ...
                <p className="text-xs sm:text-sm font-medium text-slate-500">Type</p>
              </div>
              <h3 className="text-base sm:text-lg lg:text-xl font-bold text-slate-900 truncate">{device.type}</h3>
            </div>

            <div className="bg-white rounded-lg border border-slate-200 p-4 sm:p-5 lg:p-6">
              <div className="flex items-center gap-3 mb-3">
                <div className="w-10 h-10 rounded-lg bg-cyan-100 flex items-center justify-center flex-shrink-0">
                  <svg className="w-5 h-5 sm:w-6 sm:h-6 text-cyan-600" fill="none" viewBox="0 0 24 24" stroke="currentColor" strokeWidth={2}>
              ...
              <h3 className="text-base sm:text-lg lg:text-xl font-bold text-slate-900 line-clamp-2">{device.location}</h3>
            </div>
            ...
            <div className={`rounded-lg border p-4 sm:p-5 lg:p-6 ${
              ...
              <div className="flex items-center gap-3 mb-3">
                <div className={`w-10 h-10 rounded-lg flex items-center justify-center flex-shrink-0 ${
                  ...
                  <svg className={`w-5 h-5 sm:w-6 sm:h-6 ${isOnline ? "text-teal-600" : "text-amber-600"}`} fill="none" viewBox="0 0 24 24" stroke="currentColor" strokeWidth={2}>
                    {isOnline ? (
                ...
                <p className={`text-xs sm:text-sm font-medium ${isOnline ? "text-teal-700" : "text-amber-700"}`}>
                  Status
                </p>
              </div>
              <h3 className={`text-base sm:text-lg lg:text-xl font-bold ${isOnline ? "text-teal-700" : "text-amber-700"}`}>
          ...
          <div className="bg-white rounded-lg border border-slate-200 p-4 sm:p-6 lg:p-8 shadow-sm">
            <div className="flex flex-col sm:flex-row sm:items-center justify-between gap-3 mb-4 sm:mb-6">
              ...
              <div className="flex items-center gap-2 px-3 py-1.5 bg-indigo-50 border border-indigo-200 rounded-lg w-fit">
                ...
                <span className="text-xs font-semibold text-indigo-700">Analytics</span>
              </div>
            </div>
            ...
            {loading ? (
              <div className="h-64 sm:h-80 lg:h-96 flex items-center justify-center">
                <div className="text-center">
                  ...
                  <p className="text-xs sm:text-sm text-slate-600">Loading telemetry...</p>
                </div>
              </div>
            ) : telemetry.length > 0 ? (
